...
```
Irreducible finite dimensional representations of $P$ are in one-to-one correspondence with $L$-dominant weights, where $L$ is the root system generated by $S$. We construct such bundles starting from any $L$-dominant weight of $G$.
