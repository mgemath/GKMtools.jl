...
# function count_iso(ls::Vector{Int64}, col::Tuple{Vararg{Int64}}, marks::Vector{Int64})::Int64
function count_iso(ls::Vector{Int64}, col::Vector{Int64}, marks::Vector{Int64})::Int64
...
function count_iso(ls::Vector{Int64}, col::Vector{Int64} = Int64[])::Int64
  ...
  last_col::Vector{Int64} = is_empty ? col : col[my_child[1]:my_child[2]-1]
