function invert_marks(mark::Vector{Int64}, n_vert::Int64)::Dict{Int64,Vector{Int64}}
...
function num_marks(mark::Vector{Int64}, v::Int64)::Int64
...
function ismin(ls::Vector{Int64}, col::Vector{Int64}, m::Vector{Int64}, par::Vector{Int64}, sub_end::Vector{Int64})::Bool
