...
julia> foreach(d -> println(gromov_witten(G, d*beta, 2, P; show_bar=false)), 1:4)
0
1
-3//2
401//144
...
julia> for g in 0:3, d in 1:3
           val = gromov_witten(G, d * beta, 2, P; g=g, show_bar=false)
           println("g=$g, d=$d: $val")
       end
g=0, d=1: 2
g=0, d=2: 1//4
